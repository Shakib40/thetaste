...
const Basket = (props) => {
    ...
    const {cartItems , onAdd , onRemove , UpdateNow , DeleteOrder}  = props;
    ...
    return(
       ...
       <aside style={ChartStyle} >
         ...
         <div>
            <button onClick={() => UpdateNow(itemsPrice) } style ={OrderButton}> Confirm Order </button>
         </div>

         <div>
            <button onClick={() => DeleteOrder() } style ={OrderButton}> Delete Order </button>
         </div>
